...
- Place reusable logic in `shared/` or `entities/` when it’s truly cross-slice.
...
- Avoid using deprecated functions or APIs — always use the latest stable React and TypeScript syntax.
...
## 💡 Note: This project must remain consistent with the above conventions.
